...
export const settingsSections = Object.freeze<readonly SettingsSectionNavItem[]>([
  ...
  },
  {
    key: "identity",
    label: "登录与身份",
    routeName: productionRouteNames.settingsIdentity,
    statusLabel: "待接入",
    capabilityState: "gated",
  },
]);
...
export const settingsGatePages = Object.freeze<Record<SettingsCapabilityGateConfig["key"], SettingsCapabilityGateConfig>>({
  personalization: {
    ...
    runtimeStatusLabel: "Desktop/Core 正常",
    fields: [
    ...
    disabledReason: "个性化 Feature Spec 与持久化链路尚未接入。",
  },
  memory: {
    key: "memory",
    eyebrow: "Settings",
    ...
    noticeTitle: "个人记忆待接入",
    noticeText: "本页不读取 Memory Store，不展示假记忆，也不提供查看、编辑或删除结果。",
    dataOrigin: "static_product_copy",
    capabilityState: "gated",
    capabilityLabel: "功能尚未接入",
    runtimeStatusLabel: "Desktop/Core 正常",
    ...
    disabledReason: "Personal Memory Store、审核和持久化能力尚未接入。",
  },
  feedback: {
    key: "feedback",
    eyebrow: "Settings",
    ...
    disabledReason: "Feedback Feature Spec、提交通道和后端状态尚未接入。",
  },
  identity: {
    key: "identity",
    eyebrow: "Settings",
    ...
    disabledReason: "Enterprise Identity、SSO 和 RBAC Projection 尚未接入。",
  },
});
