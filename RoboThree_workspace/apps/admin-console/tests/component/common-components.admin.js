...
describe('Admin common components', () => {
    it('does not emit button actions while disabled or loading', async () => {
        const disabled = mount(AdminButton, {
            propsData: {
                disabled: true
            },
            slots: {
        ...
        const loading = mount(AdminButton, {
            propsData: {
                loading: true
            },
            slots: {
        ...
        const active = mount(AdminButton, {
            slots: {
                default: '可执行'
            }
        });
    ...
    it('renders secret status as enum-only display text', () => {
        const wrapper = mount(SecretStatus, {
            propsData: {
                status: 'configured'
            }
        });
    ...
    it('keeps operation denial separate from menu and route assumptions', () => {
        const wrapper = mount(OperationGate, {
            propsData: {
                action: {
                    allowed: false,
    ...
    it('renders table loading, empty and ready states without fake pagination success', () => {
        const loading = mount(AdminTable, {
            propsData: {
                columns,
                loading: true
            }
    ...
    it('renders field, input, select, checkbox and readonly structures with safe text', async () => {
        ...
        const select = mount(SelectShell, {
            propsData: {
                id: 'select-alpha',
                label: '状态',
                value: '',
        ...
        const checkbox = mount(CheckboxShell, {
            propsData: {
                label: '启用展示入口',
                checked: false,
                disabled: true
        ...
        const readonly = mount(ReadonlyField, {
            propsData: {
                label: '连接状态',
                value: '暂不可用'
            }
    ...
    it('provides modal, confirm dialog and drawer accessibility shells', async () => {
        ...
        const drawer = mount(DrawerShell, {
            propsData: {
                open: true,
                title: '抽屉',
