...
@RestController
@RequestMapping(path = "/v1alpha3/model-invocations")
@ConditionalOnBean(ModelInvocationV1Alpha3GatewayService.class)
@ConditionalOnProperty(
        name = "robothree.model-gateway.enterprise-reasoning-v1alpha3-enabled",
        havingValue = "true")
...
public final class ModelInvocationV1Alpha3Controller {
    ...
    @PostMapping(path = "/{invocationId}/cancel",
    ...
    public ResponseEntity<ObjectNode> cancel(
            ...
            @PathVariable UUID invocationId,
            @RequestBody ObjectNode document) {
        var command = ModelInvocationHttpMapper.parseCancelV1Alpha3(document);
        ModelInvocation invocation = observations.observe(
    ...
    public SseEmitter events(
        ...
        Thread.ofVirtual().name("robothree-model-v1alpha3-sse-" + invocationId)
